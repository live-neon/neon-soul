...
} from './lib/template-extractor.js';
export {
  createPrincipleStore,
  type PrincipleStore,
  type AddSignalResult,
} from './lib/principle-store.js';
export {
  compressPrinciples,
  generateSoulMd,
...
export {
  ...
  diffSouls,
  type GeneratedSoul,
  type SoulGeneratorOptions,
  type NotationFormat,
} from './lib/soul-generator.js';

export {
  collectSources,
  formatSourceSummary,
  type SourceCollection as CollectedSources,
  type ParsedSoul,
  type UserContext,
  type SourceStats,
